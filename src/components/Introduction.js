      ...
      <div className="introduction-container">
        <div className="introduction">
          ...
          <h5>
            ...
            <p>1.  A year and a half ago, I had never been on a sailboat. I now have my Captain’s license.</p>
            <p>2.  One of the first website consulting gigs I got was from a national archery organization. I used the money I made on it to buy a bow, and I’ve been shooting archery ever since.</p>
            <p>3.  I average a book a week, and I haven’t broken my reading streak in two years.</p>
          </h5>
        </div>
      </div>
    );
